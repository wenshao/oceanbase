  ...
  namespace updateserver
  {
    ...
    class ObUpsRpcStub : public common::ObCommonRpcStub
    {
      ...
      public:
        ...
        virtual int get_client_config(const common::ObServer &root_server, common::ObClientConfig &client_config, const int64_t timeout_us);
        int get_inst_master_ups(const common::ObServer &root_server, common::ObServer &ups_master, const int64_t timeout_us);
        int get_master_obi_rs(common::ObServer &root_server, const common::ObClientConfig client_config, const int64_t timeout_us);
