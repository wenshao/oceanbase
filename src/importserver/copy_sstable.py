    ...
    for f in files:
      ...
      if m is not None:
        ...
        for h in ups_slaves:
          ...
          Shell.sh(rsync_cmd)
          logging.info(R('Successfully push "{filename}" to ups slave '
              '{h}:{dest_dir}', locals()))
...
if __name__ == '__main__':
  ...
  logging.info('ups slave list is ' + str(ups_slaves))
