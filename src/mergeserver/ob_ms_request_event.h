#ifndef OCEANBASE_MERGER_RPC_REQUEST_H_
#define OCEANBASE_MERGER_RPC_REQUEST_H_
...
namespace oceanbase
{
  namespace mergeserver
  {
    ...
    class ObMergerRequestEvent:public common::ObInnerIterator
    {
    public:
      ObMergerRequestEvent(ObMergerLocationCacheProxy * proxy, const ObMergerAsyncRpcStub * async_rpc);
      virtual ~ObMergerRequestEvent();
    ...
    private:
      ...
      // statistic the used time for per chunkserver
      void request_used_time(const ObMergerRpcEvent * rpc);
    public:
      static const int64_t MAX_SERVER_ADDR_SIZE = 128;
...
#endif // OCEANBASE_MERGER_RPC_REQUEST_H_
