  ...
  namespace mergeserver
  {
    ...
    private:
      ...
      struct sharding_result_t
      {
        ...
        void init(common::ObScanner & sharding_res, const common::ObRange & query_range, const common::ObScanParam &param, 
          common::ObString & last_proces_rowkey, const int64_t fullfilled_item_num);
        bool operator<(const sharding_result_t & other)const;
      };
      static const int64_t MAX_SHARDING_RESULT_COUNT = mergeserver::ObMergerRequestEvent::MAX_SUBREQUEST_NUM;
