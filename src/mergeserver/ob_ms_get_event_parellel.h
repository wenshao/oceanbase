 ...
 *
 * ob_ms_get_event_parellel.h for
 *
 * Authors:
 *   wushi <wushi.ly@taobao.com>
 *
 */
#ifndef MERGESERVER_OB_MS_GET_EVENT_PARELLEL_H_
#define MERGESERVER_OB_MS_GET_EVENT_PARELLEL_H_
...
namespace oceanbase
{
  ...
  {
    class ObMergerParellelGetEvent:public ObMergerRequestEvent
    {
    public:
      ObMergerParellelGetEvent(ObMergerLocationCacheProxy * cache_proxy, ObMergerAsyncRpcStub * async_rpc);
      ~ObMergerParellelGetEvent()
      {
      }
      ...
      static const int64_t DEFAULT_RESERVE_PARAM_COUNT = 5;
...
#endif /* MERGESERVER_OB_MS_GET_EVENT_PARELLEL_H_ */
