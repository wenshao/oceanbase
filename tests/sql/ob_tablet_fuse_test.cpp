...
class ObTabletFuseTest: public ::testing::Test
{
  public:
    ...
    void test(const char* sstable_file, const char *ups_file, const char *schema_file, const char *result_file);

  private:
    
};

void ObTabletFuseTest::test(const char* sstable_file, const char *ups_file, const char *schema_file, const char *result_file)
{
...
TEST_F(ObTabletFuseTest, big_data_test)
{
  ...
  test("tablet_fuse_test_data/big_sstable.ini", "tablet_fuse_test_data/big_ups_scan.ini", "tablet_fuse_test_data/schema.ini", "tablet_fuse_test_data/big_result.ini");
}

TEST_F(ObTabletFuseTest, basic_test)
{
  test("tablet_fuse_test_data/sstable.ini", "tablet_fuse_test_data/ups_scan.ini", "tablet_fuse_test_data/schema.ini", "tablet_fuse_test_data/result.ini");
}
