...
class MockObRootRpcStub : public ObRootRpcStub {
 public:
  ...
  MOCK_METHOD5(migrate_tablet,
      int(const common::ObServer& src_cs, const common::ObServer& dest_cs, const common::ObRange& range, bool keep_src, const int64_t timeout_us));
  MOCK_METHOD4(create_tablet,
      int(const common::ObServer& cs, const common::ObRange& range, const int64_t mem_version, const int64_t timeout_us));
