      ...
      TEST_F(TestRootTable2, test_table_id_exist)
      {
        ...
        TEST_F(TestRootTable2, test_check_tablet_version)
        {
...

          {
            ...
            root_table->shrink_to(shrink_table, delete_list);
            shrink_table->sort();
            ASSERT_EQ(OB_SUCCESS, shrink_table->check_tablet_version_merged(1, is_merged));
            ASSERT_EQ(is_merged, true);

            ASSERT_EQ(OB_SUCCESS, shrink_table->check_tablet_version_merged(2, is_merged));
            ASSERT_EQ(is_merged, true);

            ASSERT_EQ(OB_SUCCESS, shrink_table->check_tablet_version_merged(3, is_merged));
          ...
          }
          {
            ...
            ASSERT_EQ(OB_SUCCESS, root_table->check_tablet_version_merged(2, is_merged));
            ASSERT_EQ(is_merged, false);
