...
namespace oceanbase
{
  namespace updateserver
  {
                                  ...
                                  const bool dio, const bool is_trunc)
    {
      ...
      else if (OB_SUCCESS != (err = file.open(ObString(static_cast<int32_t>(strlen(file_name)), static_cast<int32_t>(strlen(file_name)), file_name), dio, true, is_trunc, OB_DIRECT_IO_ALIGN)))
      {
