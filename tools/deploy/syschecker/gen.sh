...
(rm -f $sstable_dir/*; ./gen_sstable -s $config -t 1001,1002 -m $rows_cnt_per_sstable -N $sstable_cnt -i $i -l $seed -x 0 -u -j -c snappy_1.0 -d $sstable_dir $extra >log/gen.log 2>&1)&
done
